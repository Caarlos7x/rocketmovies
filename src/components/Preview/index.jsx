...
export function Preview({ data, ...rest}){
  return(
    ...
    <Container {...rest} >
      ...
      <div className='autor'>
        <div> 
          <img src="https:www.github.com/caarlos7x.png" alt="foto de carlos" />
      ...
      <p>
        ...
        inóspito já que é coberto por um oceano raso e agitado por ondas enormes.
        Uma onda atinge a tripulação enquanto Amelia tenta recuperar os dados de
        Miller, matando Doyle e atrasando a partida. Ao voltarem para a Endurance,
